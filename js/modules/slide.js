/*
Deve se criar um container ".slide-wrapper" e uma ul ".slide" para que funcione.

Caso queira adicionar navegação por setas crie os botões e especifique ao acionar addArrow();
*/
